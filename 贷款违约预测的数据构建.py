...
loanfile = os.listdir('D:/Users/scorecard/xxclass/csv')
createVar = locals()
for i in loanfile:
    if i.endswith("csv") and i.split('.')[0] !='application':
        createVar[i.split('.')[0]] = pd.read_csv(os.path.join('D://Users//scorecard//xxclass//csv/',i),encoding='gbk')
        print(i.split('.')[0])
        print(os.path.join('D:/Users/scorecard/xxclass/csv/',i))
...
for_predict['prob']=lg.predict(for_predict)
